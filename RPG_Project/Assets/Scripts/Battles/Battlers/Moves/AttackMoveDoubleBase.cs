...
[CreateAssetMenu]
public class AttackMoveDoubleBase : MoveBase
{
    ...
    public override string RunMoveResult(BattleUnit sourceUnit, BattleUnit targetUnit){
        int damage1 = targetUnit.Battler.TakeDamage(power, sourceUnit.Battler, Mathf.Max(1, power / 5));
        int damage2 = targetUnit.Battler.TakeDamage(power, sourceUnit.Battler, Mathf.Max(1, power / 5));
